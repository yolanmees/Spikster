...
>
    ...
    <div class="flex min-h-screen items-center justify-center p-4 sm:p-0">
        <div
            ...
            class="relative w-full {{ $maxWidthClass }} transform overflow-hidden rounded-xl bg-white dark:bg-gray-800 shadow-2xl ring-1 ring-black/10 dark:ring-white/10 transition-all sm:my-8"
        >
            {{-- Header --}}
