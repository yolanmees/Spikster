     ...
     <div x-show="sidebarOpen" class="relative z-50 xl:hidden" role="dialog" aria-modal="true">
                         ...
                         <ul role="list" class="flex flex-1 flex-col gap-y-7">
                             <li>
                                 <ul role="list" class="-mx-2 space-y-2">
                                     ...
                                     {{-- <li>
                                        <a href="/usage" class="@if (request()->is('usage*')) sidebar-item-active @else sidebar-item @endif">
