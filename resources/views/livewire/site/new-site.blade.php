<div>
    <form wire:submit.prevent="submit">
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" id="domain" wire:model="domain" placeholder="e.g. example.com"
                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-purple-700 focus:ring-purple-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm"
                        autocomplete="off">
                    @error('domain')
            ...
            <!-- Information Box -->
            <div class="p-4 rounded-md bg-zinc-50 dark:bg-zinc-800/50">
                <div class="flex">
            ...
            <div class="flex items-center justify-end pt-6 space-x-3 border-t border-gray-200 dark:border-gray-700">
                <button type="button" wire:click="resetForm"
                    class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm dark:border-gray-600 dark:text-gray-300 dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-zinc-500"
                    wire:loading.attr="disabled" wire:target="submit">
                    Reset
                </button>

                <button type="submit"
                    class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-purple-700 border border-transparent rounded-md shadow-sm hover:bg-purple-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disabled:opacity-50 disabled:cursor-not-allowed"
                    wire:loading.attr="disabled" wire:target="submit">
