<div>
    ...
    <div class="space-y-3">
        ...
        <!-- MySql -->
        <div
            class="relative p-4 transition-all duration-200 bg-white border border-gray-200 group dark:bg-gray-800/30 rounded-xl dark:border-gray-700/50 hover:border-zinc-200 dark:hover:border-zinc-700 hover:shadow-sm">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <div class="flex items-center justify-center w-10 h-10 rounded-lg bg-zinc-100 dark:bg-zinc-800/50">
        ...
        <div
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <div
                        class="flex items-center justify-center w-10 h-10 rounded-lg bg-zinc-100 dark:bg-zinc-800/50">
                        <svg class="w-6 h-6 text-zinc-600 dark:text-zinc-400" fill="none"
