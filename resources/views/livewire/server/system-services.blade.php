<div>
    ...
    <div class="space-y-3">
        <!-- nginx -->
        <div
            class="relative p-4 transition-all duration-200 bg-white border border-gray-200 group dark:bg-gray-800/30 rounded-xl dark:border-gray-700/50 hover:border-green-200 dark:hover:border-green-800/50 hover:shadow-sm">
            <div class="flex items-center justify-between">
                ...
                <button type="button" wire:click="restartService('nginx')"
                    ...
                    wire:loading.attr="disabled" wire:target="restartService('nginx')">
        ...
        <!-- PHP-FPM -->
        <div
            class="relative p-4 transition-all duration-200 bg-white border border-gray-200 group dark:bg-gray-800/30 rounded-xl dark:border-gray-700/50 hover:border-purple-200 dark:hover:border-purple-800/50 hover:shadow-sm">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <div
                        class="flex items-center justify-center w-10 h-10 rounded-lg bg-purple-50 dark:bg-purple-900/20">
                ...
                <button type="button" wire:click="restartService('php')"
                    class="inline-flex items-center gap-2 px-4 py-2.5 border border-yellow-300 dark:border-yellow-600/50 text-sm font-semibold rounded-lg text-yellow-700 dark:text-yellow-300 bg-yellow-50 dark:bg-yellow-900/10 hover:bg-yellow-100 dark:hover:bg-yellow-900/20 focus:outline-none focus:ring-4 focus:ring-yellow-300/20 disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-105 active:scale-95 transition-all duration-200"
                    wire:loading.attr="disabled" wire:target="restartService('php')">
        ...
        <!-- MySql -->
        <div
            class="relative p-4 transition-all duration-200 bg-white border border-gray-200 group dark:bg-gray-800/30 rounded-xl dark:border-gray-700/50 hover:border-blue-200 dark:hover:border-blue-800/50 hover:shadow-sm">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                ...
                <button type="button" wire:click="restartService('mysql')"
                    class="inline-flex items-center gap-2 px-4 py-2.5 border border-yellow-300 dark:border-yellow-600/50 text-sm font-semibold rounded-lg text-yellow-700 dark:text-yellow-300 bg-yellow-50 dark:bg-yellow-900/10 hover:bg-yellow-100 dark:hover:bg-yellow-900/20 focus:outline-none focus:ring-4 focus:ring-yellow-300/20 disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-105 active:scale-95 transition-all duration-200"
                    wire:loading.attr="disabled" wire:target="restartService('mysql')">
        ...
        <!-- Redis -->
        <div
            class="relative p-4 transition-all duration-200 bg-white border border-gray-200 group dark:bg-gray-800/30 rounded-xl dark:border-gray-700/50 hover:border-red-200 dark:hover:border-red-800/50 hover:shadow-sm">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                ...
                <button type="button" wire:click="restartService('redis')"
                    class="inline-flex items-center gap-2 px-4 py-2.5 border border-yellow-300 dark:border-yellow-600/50 text-sm font-semibold rounded-lg text-yellow-700 dark:text-yellow-300 bg-yellow-50 dark:bg-yellow-900/10 hover:bg-yellow-100 dark:hover:bg-yellow-900/20 focus:outline-none focus:ring-4 focus:ring-yellow-300/20 disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-105 active:scale-95 transition-all duration-200"
                    wire:loading.attr="disabled" wire:target="restartService('redis')">
        ...
        <!-- Supervisor -->
        <div
            class="relative p-4 transition-all duration-200 bg-white border border-gray-200 group dark:bg-gray-800/30 rounded-xl dark:border-gray-700/50 hover:border-indigo-200 dark:hover:border-indigo-800/50 hover:shadow-sm">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <div
                        class="flex items-center justify-center w-10 h-10 rounded-lg bg-indigo-50 dark:bg-indigo-900/20">
                ...
                <button type="button" wire:click="restartService('supervisor')"
                    class="inline-flex items-center gap-2 px-4 py-2.5 border border-yellow-300 dark:border-yellow-600/50 text-sm font-semibold rounded-lg text-yellow-700 dark:text-yellow-300 bg-yellow-50 dark:bg-yellow-900/10 hover:bg-yellow-100 dark:hover:bg-yellow-900/20 focus:outline-none focus:ring-4 focus:ring-yellow-300/20 disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-105 active:scale-95 transition-all duration-200"
                    wire:loading.attr="disabled" wire:target="restartService('supervisor')">
                    <span wire:loading.remove wire:target="restartService('supervisor')"
