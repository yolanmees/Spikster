    ...
    <form wire:submit="submit">
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    <label for="serverName" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                        {{ __('spikster.server_name') }} <span class="text-red-500">*</span>
                    </label>
                    <input type="text" id="serverName" wire:model="serverName" placeholder="bijv. Production Server"
                ...
                <div>
                    <label for="serverIp" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                        {{ __('spikster.server_ip') }} <span class="text-red-500">*</span>
                    </label>
                    <input type="text" id="serverIp" wire:model="serverIp" placeholder="bijv. 123.45.67.89"
                ...
                <div>
                    <label for="serverProvider" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                        {{ __('spikster.server_provider') }} <span class="text-red-500">*</span>
                    </label>
                    <input type="text" id="serverProvider" wire:model="serverProvider"
                        placeholder="bijv. DigitalOcean, AWS, Hetzner"
                ...
                <div>
                    ...
                    <input type="text" id="serverLocation" wire:model="serverLocation"
                        placeholder="bijv. Amsterdam, Frankfurt"
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">SSH Configuratie</h3>
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <!-- SSH Port -->
                    <div>
                        <label for="serverSshPort" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            SSH Poort <span class="text-red-500">*</span>
                        </label>
                        ...
                        @error('serverSshPort')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Standaard: 22</p>
                    </div>
                    ...
                    <div>
                        <label for="serverSshPassword"
                            ...
                            SSH Wachtwoord <span class="text-red-500">*</span>
                        </label>
                        ...
                        @error('serverSshPassword')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Minimaal 8 karakters</p>
                    </div>
                </div>
            </div>
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">API Configuratie (optioneel)</h3>
                <div>
                    ...
                    <input type="text" id="serverApiKey" wire:model="serverApiKey"
                        placeholder="Voor automatische server beheer"
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        Voor DigitalOcean, AWS, etc. automatisatie
                    </p>
                </div>
            </div>
