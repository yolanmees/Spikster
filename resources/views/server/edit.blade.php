...
@section('content')
    <div x-data="{ tab: 'monitor' }">
                ...
                <div class="border-b-2 border-gray-200 dark:border-gray-700">
                    <nav class="flex -mb-px space-x-6" aria-label="Tabs">
                        <button @click="tab = 'monitor'"
                            ...
                            <svg class="w-5 h-5" :class="tab === 'monitor' ? 'text-blue-500' : 'text-gray-400 group-hover:text-gray-500'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button @click="tab = 'server'"
                            :class="tab === 'server' ? 'border-blue-500 text-blue-600 dark:text-blue-400' :
                                'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300'"
                            class="group inline-flex items-center gap-2 py-4 px-1 border-b-2 font-semibold text-sm transition-all duration-200">
                            <svg class="w-5 h-5" :class="tab === 'server' ? 'text-blue-500' : 'text-gray-400 group-hover:text-gray-500'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button @click="tab = 'security'"
                            :class="tab === 'security' ? 'border-blue-500 text-blue-600 dark:text-blue-400' :
                                'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300'"
                            class="group inline-flex items-center gap-2 py-4 px-1 border-b-2 font-semibold text-sm transition-all duration-200">
                            <svg class="w-5 h-5" :class="tab === 'security' ? 'text-blue-500' : 'text-gray-400 group-hover:text-gray-500'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button @click="tab = 'tools'"
                            :class="tab === 'tools' ? 'border-blue-500 text-blue-600 dark:text-blue-400' :
                                'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300'"
                            class="group inline-flex items-center gap-2 py-4 px-1 border-b-2 font-semibold text-sm transition-all duration-200">
                            <svg class="w-5 h-5" :class="tab === 'tools' ? 'text-blue-500' : 'text-gray-400 group-hover:text-gray-500'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <x-card header="Server Logs" size="md" dark="false">
                <div class="space-y-4">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-gray-600 to-gray-800 flex items-center justify-center shadow-lg">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6" x-show="tab === 'security'" x-transition style="display: none;">
                    ...
                    <div class="relative group">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <x-action-button :href="route('server.fail2ban', $server_id)" class="inline-flex items-center gap-2 transform hover:scale-105 transition-all duration-200">
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                            ...
                            <span class="text-xs font-semibold text-green-600 dark:text-green-400 bg-green-100 dark:bg-green-900/30 px-2 py-1 rounded">Active</span>
                        </div>
                        ...
                        <div class="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                            ...
                            <span class="text-xs font-semibold text-green-600 dark:text-green-400 bg-green-100 dark:bg-green-900/30 px-2 py-1 rounded">Configured</span>
                        </div>
                        ...
                        <div class="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                            ...
                            <span class="text-xs font-semibold text-green-600 dark:text-green-400 bg-green-100 dark:bg-green-900/30 px-2 py-1 rounded">Enabled</span>
                        </div>
                    </div>
                </div>
            </x-card>
        </div>
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6" x-show="tab === 'tools'" x-transition style="display: none;">
            ...
            <x-card header="Scheduled Tasks" size="md" dark="false">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <x-primary-button type="button" id="editcrontab" class="w-full inline-flex items-center justify-center gap-2 transform hover:scale-105 transition-all duration-200">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <x-card header="System Access" size="md" dark="false">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <x-danger-button type="button" id="rootreset" class="w-full inline-flex items-center justify-center gap-2 transform hover:scale-105 transition-all duration-200">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                            </svg>
