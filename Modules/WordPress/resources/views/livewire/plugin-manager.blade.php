                ...
                <div class="flex-1 overflow-y-auto p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="text-gray-700 dark:text-gray-300 prose dark:prose-invert max-w-none">
                            {!! strip_tags(($selectedWpOrgPlugin['sections']['description'] ??
                                ($selectedWpOrgPlugin['short_description'] ?? 'No description available.')), '<p><a><strong><em><ul><ol><li><br><h3><h4><blockquote><code><pre>') !!}
                        </div>
                    </div>
