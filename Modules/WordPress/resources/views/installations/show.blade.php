...
@section('content')
    <div x-data="{ tab: 'overview' }">
        ...
        <ol class="breadcrumbs">
            ...
            <li class="breadcrumb-item active">Version: <b><span
                        class="ml-1">{{ $installation->version ?? 'Unknown' }}</span></b></li>
            <li class="breadcrumb-item active">Status: <b><span
                        class="ml-1 {{ $installation->status === 'active' ? 'text-green-600 dark:text-green-400' : 'text-gray-600' }}">{{ ucfirst($installation->status) }}</span></b>
            </li>
        </ol>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                                ...
                                <span
                                    class="text-sm font-semibold text-gray-900 dark:text-white">{{ $installation->version ?? 'Unknown' }}</span>
                            </div>
                            <div class="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Status</span>
                                <span
                                    class="inline-block px-2 py-1 text-xs font-medium rounded-full {{ $installation->status === 'active' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' : 'bg-gray-100 text-gray-700' }}">
                            ...
                            <div class="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                                ...
                                <span
                                    class="text-sm font-semibold text-gray-900 dark:text-white">{{ $installation->locale }}</span>
                            </div>
                            <div class="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Auto Update</span>
                                <span
                                    class="text-sm font-semibold {{ $installation->auto_update ? 'text-green-600 dark:text-green-400' : 'text-gray-900 dark:text-white' }}">
                ...
                <x-card header="Quick Actions" size="md" dark="false">
                    <div class="space-y-3">
                        ...
                        <form action="{{ route('wordpress.destroy', $installation->id) }}" method="POST"
                            onsubmit="return confirm('Are you sure? This will delete all WordPress files and database.')">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
                                class="w-full inline-flex items-center justify-center gap-2 px-5 py-3 border-2 border-red-500 dark:border-red-600 text-sm font-semibold rounded-lg text-red-700 dark:text-red-300 bg-red-50 dark:bg-red-900/20 hover:bg-red-100 dark:hover:bg-red-900/40 focus:outline-none focus:ring-4 focus:ring-red-300/50 transform hover:scale-105 active:scale-95 transition-all duration-200">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span
                                        class="text-xs font-medium text-gray-900 dark:text-white">{{ $installation->database->name ?? 'N/A' }}</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-xs text-gray-600 dark:text-gray-400">Database User</span>
                                    <span
                                        class="text-xs font-medium text-gray-900 dark:text-white">{{ $installation->databaseUser->username ?? 'N/A' }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex flex-col gap-1">
                                    ...
                                    <code
                                        class="text-xs bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-gray-900 dark:text-white break-all">
                                ...
                                <div class="flex flex-col gap-1">
                                    ...
                                    <a href="{{ $installation->getAdminUrl() }}" target="_blank"
                                        class="text-xs text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 break-all">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ $installation->path }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                            {{ $installation->auto_update ? 'Enabled' : 'Disabled' }}</p>
                                    </div>
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $installation->auto_update ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-400' }}">
                            ...
                            @if ($installation->is_multisite)
                                <div
                                    class="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border-2 border-purple-200 dark:border-purple-800">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div>
                                            <p class="text-sm font-medium text-purple-900 dark:text-purple-300">Multisite
                                                Enabled</p>
                                            <p class="text-xs text-purple-700 dark:text-purple-400">This is a WordPress
                ...
                <x-card header="Site Information" size="md" dark="false">
                    <div class="space-y-4">
                        ...
                        <div class="space-y-3">
                            <div class="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                                <div class="flex justify-between items-start">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                            {{ $installation->site->server->name ?? 'N/A' }}</p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">
                                            {{ $installation->site->server->ip ?? 'N/A' }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            @if ($installation->hasUpdatesAvailable())
                                <div
                                    class="p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg border-2 border-orange-200 dark:border-orange-800">
                                    <div class="flex justify-between items-start">
                                        <div class="flex-1">
                                            <p class="text-sm font-medium text-orange-900 dark:text-orange-300">Updates
                                                Available</p>
                                            <p class="text-2xl font-bold text-orange-600 dark:text-orange-400 mt-1">
                                                {{ $installation->getUpdatesCount() }}</p>
                                        </div>
                                        <button @click="tab = 'updates'"
